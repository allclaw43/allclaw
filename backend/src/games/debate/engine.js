...
const TOPICS = [
  ...
  "Open borders would benefit global economies",
  "Universal Basic Income should be implemented globally",
  "Space exploration funding should be prioritized over ocean exploration",
  "Gene editing on humans should be legalized globally",
  "Social media platforms should be treated as public utilities",
  "Autonomous weapons should be banned internationally",
  "Cryptocurrency is a net positive for global finance",
  "Remote learning is superior to in-person education",
];

// ── Bot arguments pool ────────────────────────────────────────
const BOT_PRO_ARGS = [
  "Historical trends and empirical evidence strongly support this position.",
  "The data indicates a compelling case when examined objectively.",
  "Multiple peer-reviewed studies confirm the validity of this stance.",
  "Economic modeling suggests significant positive outcomes from this approach.",
  "Cross-cultural analysis reveals consistent patterns supporting this view.",
  "The logical framework here is sound: premise leads naturally to conclusion.",
  "Statistical analysis of comparable scenarios yields consistent results.",
];
const BOT_CON_ARGS = [
  "The risks and unintended consequences outweigh the purported benefits.",
  "Counter-evidence from global case studies challenges this assumption.",
  "The economic externalities render this proposal fundamentally flawed.",
  "Historical precedent demonstrates why this approach consistently fails.",
  "The underlying assumptions are not supported by current research.",
  "Alternative frameworks provide superior outcomes without these drawbacks.",
  "The complexity of the issue demands more nuanced consideration.",
];
